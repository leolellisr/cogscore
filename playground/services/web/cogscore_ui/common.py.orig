...
:root {
  --cog-primary: #d94b50;
  --cog-primary-soft: rgba(217, 75, 80, 0.10);
  --cog-border: rgba(128, 128, 128, 0.24);
}
.block-container {padding-top: 2rem; padding-bottom: 3rem; max-width: 1500px;}
[data-testid="stSidebar"] {border-right: 1px solid var(--cog-border);}
.cog-eyebrow {font-size: .78rem; text-transform: uppercase; letter-spacing: .08em; opacity: .65; margin-bottom: .2rem;}
.cog-card {border: 1px solid var(--cog-border); border-radius: 12px; padding: 1rem 1.1rem; margin-bottom: .75rem;}
...
div[data-testid="stMetric"] {border: 1px solid var(--cog-border); border-radius: 12px; padding: .7rem .85rem;}
